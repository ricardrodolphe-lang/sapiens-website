        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                <div class="text-center lg:text-left space-y-6 opacity-0 animate-fade-in-up">
                    <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full glass-light border border-white/10">
                        <div class="flex -space-x-2">
                            <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face" alt="User" class="w-7 h-7 rounded-full border-2 border-slate-800">
                            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=40&h=40&fit=crop&crop=face" alt="User" class="w-7 h-7 rounded-full border-2 border-slate-800">
                            <div class="w-7 h-7 rounded-full border-2 border-slate-800 bg-blue-600 flex items-center justify-center text-[10px] font-semibold">+50</div>
                        </div>
                        <div class="flex flex-col items-start gap-0">
                            ...
                            <span class="text-xs text-slate-300"><strong class="text-white">4,5/5</strong> de satisfaction client</span>
                        </div>
                    </div>
                    ...
                    <p class="text-lg sm:text-xl text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                        On développe des solutions d'IA et d'automatisation sur mesure pour vous faire gagner en <strong class="text-white">fiabilité</strong>, en <strong class="text-white">temps</strong> et en <strong class="text-white">productivité</strong>.
                    </p>
                    
                    <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-2">
                        <a href="#audit" class="js-audit-trigger group px-6 py-3 bg-gradient-to-r from-blue-500 to-violet-500 rounded-full font-semibold text-base hover:shadow-lg hover:shadow-blue-500/25 transition-all hover:scale-105 flex items-center justify-center gap-2">
                            <span>Demander un Audit Gratuit</span>
                            <i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                        </a>
                        <a href="#solutions" class="px-6 py-3 rounded-full font-semibold text-base border border-white/20 hover:bg-white/5 transition-all flex items-center justify-center gap-2">
                ...
                <div class="relative opacity-0 animate-fade-in delay-300">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-500/30 to-violet-500/30 blur-3xl rounded-full scale-75"></div>
                                    ...
                                    <div class="grid grid-cols-3 gap-3">
                                        <div class="col-span-2 glass-light rounded-xl p-4">
                                            <div class="flex items-center justify-between mb-3">
                                                <span class="text-xs font-medium text-slate-300">Automatisations exécutées</span>
                                                <span class="text-xs text-green-400 flex items-center gap-1">
                                                    <i data-lucide="trending-up" class="w-3 h-3"></i>+24%
                                                </span>
                                            </div>
                                            <div class="flex items-end gap-1.5 h-24">
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-60" style="height: 45%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-70" style="height: 60%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-75" style="height: 50%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-80" style="height: 75%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-85" style="height: 65%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-90" style="height: 85%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-violet-600 to-violet-400 rounded-t" style="height: 100%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-75" style="height: 70%"></div>
                                                <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t opacity-60" style="height: 55%"></div>
                                            </div>
                                ...
                                <div class="md:hidden">
                                    ...
                                    <div class="glass-light rounded-lg p-3 mb-3">
                                        ...
                                        <div class="flex items-end gap-1 h-12">
                                            <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-sm opacity-50" style="height: 40%"></div>
                                            <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-sm opacity-60" style="height: 55%"></div>
                                            <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-sm opacity-70" style="height: 65%"></div>
                                            <div class="flex-1 bg-gradient-to-t from-blue-600 to-blue-400 rounded-sm opacity-80" style="height: 75%"></div>
                                            <div class="flex-1 bg-gradient-to-t from-violet-600 to-violet-400 rounded-sm" style="height: 100%"></div>
                                        </div>
                                    </div>
    ...
    <section id="solutions" class="py-24 px-4 sm:px-6 lg:px-8 relative">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="inline-block px-4 py-1.5 rounded-full text-sm font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 mb-4">
                    Nos Solutions
                </span>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="group glass rounded-2xl p-8 lg:p-10 hover:border-blue-500/30 transition-all duration-500 glow-border">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-500/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <p class="text-slate-400 mb-6 leading-relaxed">
                        Déployez des assistants virtuels capables de comprendre, analyser et agir sur vos données en temps réel. Nos agents IA s'intègrent parfaitement à vos outils existants.
                    </p>
                    ...
                    <a href="#audit" class="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 font-medium group/link">
                        <span>En savoir plus</span>
                        <i data-lucide="arrow-right" class="w-4 h-4 group-hover/link:translate-x-1 transition-transform"></i>
                    </a>
                </div>
                
                <div class="group glass rounded-2xl p-8 lg:p-10 hover:border-violet-500/30 transition-all duration-500 glow-border">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500/20 to-violet-500/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <p class="text-slate-400 mb-6 leading-relaxed">
                        Éliminez les tâches répétitives et créez des workflows automatisés qui fonctionnent 24/7. Connectez tous vos outils dans un écosystème fluide et efficace.
                    </p>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-3 text-slate-300">
                    ...
                    <a href="#audit" class="inline-flex items-center gap-2 text-violet-400 hover:text-violet-300 font-medium group/link">
                        <span>En savoir plus</span>
                        <i data-lucide="arrow-right" class="w-4 h-4 group-hover/link:translate-x-1 transition-transform"></i>
                    </a>
                </div>
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 bg-slate-900/50 border-y border-white/5" id="tabsSection">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <span class="inline-block px-4 py-1.5 rounded-full text-sm font-medium bg-violet-500/10 text-violet-400 border border-violet-500/20 mb-4">
                    Par Métier
                </span>
                <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
                ...
                <p class="text-lg text-slate-400">
                    Chaque département a ses défis uniques. Découvrez comment nos solutions s'adaptent à vos besoins spécifiques.
                </p>
            </div>
            ...
            <div class="glass rounded-2xl p-8 lg:p-12">
                <div id="tab-commercial" class="tab-content grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-slate-400 mb-6 leading-relaxed">
                            Automatisez la prospection, le suivi des leads et la qualification commerciale. Vos commerciaux se concentrent sur ce qui compte : conclure des deals.
                        </p>
                        ...
                        <div class="glass-light rounded-xl p-4 shadow-2xl border border-white/10">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center justify-between bg-slate-800/30 rounded-lg p-2.5">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-blue-500 to-violet-500 flex items-center justify-center text-[10px] font-bold">AC</div>
                                        <div>
                                            <div class="text-xs font-medium">Acme Corp</div>
                                            <div class="text-[10px] text-slate-500">Lead chaud • Score 92</div>
                                        </div>
                                    </div>
                                    <span class="text-[10px] px-2 py-1 bg-green-500/20 text-green-400 rounded-full">Qualifié</span>
                                </div>
                                <div class="flex items-center justify-between bg-slate-800/30 rounded-lg p-2.5">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-pink-500 to-orange-500 flex items-center justify-center text-[10px] font-bold">TI</div>
                                        <div>
                                            <div class="text-xs font-medium">TechInno</div>
                                            <div class="text-[10px] text-slate-500">Relance auto • Score 78</div>
                                        </div>
                                    </div>
                                    <span class="text-[10px] px-2 py-1 bg-blue-500/20 text-blue-400 rounded-full">En cours</span>
                                </div>
                                <div class="flex items-center justify-between bg-slate-800/30 rounded-lg p-2.5">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center text-[10px] font-bold">SB</div>
                                        <div>
                                            <div class="text-xs font-medium">StartupBoost</div>
                                            <div class="text-[10px] text-slate-500">Nouveau • Score 85</div>
                                        </div>
                                    </div>
                                    <span class="text-[10px] px-2 py-1 bg-yellow-500/20 text-yellow-400 rounded-full">À traiter</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="tab-rh" class="tab-content grid lg:grid-cols-2 gap-12 items-center hidden">
                    <div>
                        ...
                        <p class="text-slate-400 mb-6 leading-relaxed">
                            De l'onboarding au suivi des congés, automatisez toutes les tâches administratives pour vous concentrer sur l'humain.
                        </p>
                        <ul class="space-y-4 mb-8">
                            <li class="flex items-start gap-3">
                                <div class="w-6 h-6 rounded-full bg-violet-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div class="glass-light rounded-xl p-4 shadow-2xl border border-white/10">
                            ...
                            <div class="bg-slate-800/30 rounded-lg p-3 mb-3">
                                ...
                                <div class="flex items-center gap-3">
                                    <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=40&h=40&fit=crop&crop=face" class="w-8 h-8 rounded-full">
                                    <div class="flex-1">
                                        <div class="text-xs font-medium">Marie Dupont</div>
                                        <div class="flex items-center gap-2 mt-1">
                                            <div class="flex-1 bg-slate-700 rounded-full h-1.5">
                                                <div class="bg-gradient-to-r from-violet-500 to-pink-500 h-1.5 rounded-full" style="width: 65%"></div>
                                            </div>
                            ...
                            <div class="flex items-center justify-between bg-slate-800/30 rounded-lg p-2.5">
                                ...
                                <span class="text-[10px] px-2 py-1 bg-green-500/20 text-green-400 rounded-full">Auto-validées</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="tab-marketing" class="tab-content grid lg:grid-cols-2 gap-12 items-center hidden">
                    <div>
                        ...
                        <p class="text-slate-400 mb-6 leading-relaxed">
                            Automatisez vos campagnes, personnalisez vos messages à grande échelle et analysez vos performances en temps réel.
                        </p>
                        <ul class="space-y-4 mb-8">
                            <li class="flex items-start gap-3">
                        ...
                        <div class="glass-light rounded-xl p-4 shadow-2xl border border-white/10">
                            ...
                            <div class="bg-slate-800/50 rounded-lg p-3 mb-3">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <span class="ml-auto text-[10px] px-2 py-0.5 bg-pink-500/20 text-pink-400 rounded-full animate-pulse">IA</span>
                                </div>
                ...
                <div id="tab-support" class="tab-content grid lg:grid-cols-2 gap-12 items-center hidden">
                    <div>
                        ...
                        <p class="text-slate-400 mb-6 leading-relaxed">
                            Offrez un support 24/7 avec des chatbots intelligents et des systèmes de ticketing automatisés qui anticipent les besoins.
                        </p>
                        <ul class="space-y-4 mb-8">
                            <li class="flex items-start gap-3">
                            ...
                            <div class="bg-slate-800/50 rounded-lg p-3 mb-3">
                                <div class="space-y-2">
                                    <div class="flex gap-2">
                                        <div class="w-6 h-6 rounded-full bg-slate-600 flex items-center justify-center text-[9px]">JD</div>
                                        <div class="bg-slate-700/50 rounded-lg rounded-tl-none p-2 text-[11px] text-slate-300 max-w-[80%]">
                                            Comment puis-je réinitialiser mon mot de passe ?
                                        </div>
                                    </div>
                                    <div class="flex gap-2 justify-end">
                                        <div class="bg-cyan-500/20 rounded-lg rounded-tr-none p-2 text-[11px] text-slate-200 max-w-[80%]">
                ...
                <div id="tab-ops" class="tab-content grid lg:grid-cols-2 gap-12 items-center hidden">
                    <div>
                        ...
                        <p class="text-slate-400 mb-6 leading-relaxed">
                            Connectez tous vos outils, automatisez les flux de données et créez des tableaux de bord en temps réel pour piloter votre activité.
                        </p>
                        <ul class="space-y-4 mb-8">
                            <li class="flex items-start gap-3">
                    ...
                    <div class="relative">
                        <div class="glass-light rounded-xl p-4 shadow-2xl border border-white/10">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-[10px] px-2 py-1 bg-green-500/20 text-green-400 rounded-full">Tous systèmes OK</span>
                            </div>
                            <div class="flex items-center gap-2 mb-4 overflow-hidden">
                                <div class="flex -space-x-2">
                                    <div class="w-8 h-8 rounded-lg bg-[#00A4EF] flex items-center justify-center text-[10px] font-bold border-2 border-slate-800">SF</div>
                                    <div class="w-8 h-8 rounded-lg bg-[#4A154B] flex items-center justify-center text-[10px] font-bold border-2 border-slate-800">Sl</div>
                                    <div class="w-8 h-8 rounded-lg bg-[#0052CC] flex items-center justify-center text-[10px] font-bold border-2 border-slate-800">Jr</div>
                                    <div class="w-8 h-8 rounded-lg bg-[#34A853] flex items-center justify-center text-[10px] font-bold border-2 border-slate-800">GS</div>
                                    <div class="w-8 h-8 rounded-lg bg-slate-600 flex items-center justify-center text-[10px] border-2 border-slate-800">+8</div>
                                </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="relative group">
                    <div class="glass rounded-2xl p-6 h-full hover:border-blue-500/30 transition-all duration-300">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-4 font-display text-xl font-bold">
                            01
                        </div>
                        <h3 class="font-display text-xl font-bold mb-3">Audit</h3>
                        <p class="text-slate-400 text-sm leading-relaxed">
                            Analyse approfondie de vos processus actuels et identification des opportunités d'automatisation à fort impact.
                        </p>
                    </div>
                    <div class="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-blue-500/50 to-transparent"></div>
                </div>
                
                <div class="relative group">
                    <div class="glass rounded-2xl p-6 h-full hover:border-violet-500/30 transition-all duration-300">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-violet-600 flex items-center justify-center mb-4 font-display text-xl font-bold">
                            02
                        </div>
                    ...
                    <div class="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-violet-500/50 to-transparent"></div>
                </div>
                
                <div class="relative group">
                    <div class="glass rounded-2xl p-6 h-full hover:border-pink-500/30 transition-all duration-300">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-pink-500 to-pink-600 flex items-center justify-center mb-4 font-display text-xl font-bold">
                            03
                        </div>
                        <h3 class="font-display text-xl font-bold mb-3">Intégration</h3>
                        <p class="text-slate-400 text-sm leading-relaxed">
                            Déploiement rapide et itératif des solutions avec formation de vos équipes en conditions réelles.
                        </p>
                    </div>
                    <div class="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-pink-500/50 to-transparent"></div>
                </div>
                
                <div class="relative group">
                    <div class="glass rounded-2xl p-6 h-full hover:border-cyan-500/30 transition-all duration-300">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center mb-4 font-display text-xl font-bold">
                            04
                        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="glass rounded-2xl p-8 hover:border-blue-500/20 transition-all duration-300">
                    ...
                    <blockquote class="text-slate-300 mb-6 leading-relaxed">
                        "Les équipes Sapiens ont transformé notre processus commercial. Nos équipes gagnent 3 heures par jour grâce aux automatisations mises en place. Le ROI est incroyable."
                    </blockquote>
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-slate-400">Directeur Commercial, TechSolutions</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass rounded-2xl p-8 hover:border-violet-500/20 transition-all duration-300">
                    ...
                    <blockquote class="text-slate-300 mb-6 leading-relaxed">
                        "L'agent IA déployé pour notre support client a réduit nos tickets de 60%. Nos clients sont plus satisfaits et notre équipe peut se concentrer sur les cas complexes."
                    </blockquote>
                    <div class="flex items-center gap-4">
                ...
                <div class="glass rounded-2xl p-8 hover:border-pink-500/20 transition-all duration-300">
                    ...
                    <blockquote class="text-slate-300 mb-6 leading-relaxed">
                        "De l'audit à la mise en production, tout a été fluide. L'équipe Sapiens comprend nos enjeux métier et propose des solutions pragmatiques qui fonctionnent vraiment."
                    </blockquote>
                    <div class="flex items-center gap-4">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="space-y-4" id="faqContainer">
                <div class="glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors" data-faq="1">
                    ...
                    <div class="accordion-content" id="faq-content-1">
                        <div class="px-6 py-5 text-slate-400 leading-relaxed">
                            La plupart de nos automatisations sont déployées en 48h à 2 semaines selon leur complexité. Nous commençons toujours par un audit gratuit qui nous permet d'établir un planning précis avec des jalons clairs.
                        </div>
                    </div>
                </div>
                
                <div class="glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors" data-faq="2">
                        <span class="font-semibold pr-4">Faut-il des compétences techniques pour utiliser vos solutions ?</span>
                        <i data-lucide="chevron-down" 
                           class="faq-icon w-5 h-5 text-slate-400 flex-shrink-0 transition-transform duration-300"></i>
                    </button>
                    <div class="accordion-content" id="faq-content-2">
                        <div class="px-6 py-5 text-slate-400 leading-relaxed">
                            Pas du tout ! Nos solutions sont conçues pour être utilisées par des équipes métier sans compétences techniques. Nous assurons également une formation complète de vos équipes lors du déploiement.
                        </div>
                    </div>
                </div>
                
                <div class="glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors" data-faq="3">
                    ...
                    <div class="accordion-content" id="faq-content-3">
                        <div class="px-6 py-5 text-slate-400 leading-relaxed">
                            Lors de l'audit initial, nous mesurons le temps passé sur les tâches à automatiser et calculons les économies potentielles. En moyenne, nos clients constatent un ROI de 300% dans les 6 premiers mois.
                        </div>
                    </div>
                </div>
                
                <div class="glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors" data-faq="4">
                    ...
                    <div class="accordion-content" id="faq-content-4">
                        <div class="px-6 py-5 text-slate-400 leading-relaxed">
                            Nous intégrons plus de 500 applications : CRM (Salesforce, HubSpot), outils de productivité (Slack, Teams, Notion), ERP, logiciels métier... Si votre outil dispose d'une API, nous pouvons l'intégrer.
                        </div>
                    </div>
                </div>
                
                <div class="glass rounded-xl overflow-hidden">
                    <button class="faq-btn w-full px-6 py-5 flex items-center justify-between text-left hover:bg-white/5 transition-colors" data-faq="5">
                    ...
                    <div class="accordion-content" id="faq-content-5">
                        <div class="px-6 py-5 text-slate-400 leading-relaxed">
                            L'audit gratuit comprend : un entretien de découverte (30 min), une analyse de vos processus actuels, l'identification de 3 opportunités d'automatisation prioritaires, et une estimation du ROI potentiel. Sans engagement.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="relative glass rounded-3xl p-8 md:p-12 lg:p-16 text-center overflow-hidden">
                ...
                <div class="relative z-10">
                    <span class="inline-block px-4 py-1.5 rounded-full text-sm font-medium bg-white/10 text-white border border-white/20 mb-6">
                    ...
                    <p class="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
                        Réservez votre audit gratuit de 30 minutes et découvrez comment l'IA et l'automatisation peuvent révolutionner vos opérations.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                       <a href="#audit" class="js-audit-trigger group px-8 py-4 bg-gradient-to-r from-blue-500 to-violet-500 rounded-full font-semibold text-lg hover:shadow-lg hover:shadow-blue-500/25 transition-all hover:scale-105 flex items-center justify-center gap-2">
