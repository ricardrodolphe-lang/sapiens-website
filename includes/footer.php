        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                <div class="md:col-span-2">
                    ...
                    <p class="text-slate-400 text-sm max-w-sm leading-relaxed">
                        Solutions d'IA et d'automatisation sur mesure pour les entreprises ambitieuses qui veulent gagner en efficacité.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate-400">
                        <li><a href="mentions-legales.php" class="hover:text-white transition-colors">Mentions légales</a></li>
                        <li><a href="confidentialite.php" class="hover:text-white transition-colors">Politique de confidentialité</a></li>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/5">
                <p class="text-sm text-slate-500 mb-4 md:mb-0">
                    © <?php echo date("Y"); ?> GetSapiens.ai. Tous droits réservés.
                </p>
                <div class="flex items-center gap-4">
                    <a href="#" class="w-10 h-10 rounded-full glass-light flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-all">
    ...
    <div id="auditModal" class="fixed inset-0 z-[100] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-start justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <div class="relative transform rounded-2xl glass text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-6xl max-h-[90vh] overflow-y-auto md:overflow-y-hidden opacity-0 scale-95" id="modalPanel">                    
                    <button type="button" class="absolute right-4 top-4 z-10 p-2 rounded-full bg-white/10 hover:bg-white/20 text-slate-400 hover:text-white transition-colors" id="closeModalBtn">
