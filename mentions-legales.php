...
<section class="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen">
    <div class="max-w-4xl mx-auto">
        <div class="mb-12">
            ...
            <p class="text-slate-400">En vigueur au 01/01/2025</p>
        </div>
        ...
        <div class="space-y-12 text-slate-300 leading-relaxed">
            ...
            <div class="glass rounded-2xl p-8 border border-white/5">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="list-disc pl-5 space-y-2 marker:text-blue-400">
                        ...
                        <li><strong>Siège social :</strong> 35 BD DU CENTRE, 13008 MARSEILLE</li>
            ...
            <div class="glass rounded-2xl p-8 border border-white/5">
                <h2 class="text-2xl font-display font-bold text-white mb-6 flex items-center gap-3">
                    <i data-lucide="server" class="w-6 h-6 text-violet-400"></i>
                    2. Hébergement
                </h2>
                <p class="mb-4">Le Site est hébergé par la société <strong>o2switch</strong>.</p>
            ...
            <div class="glass rounded-2xl p-8 border border-white/5">
                <h2 class="text-2xl font-display font-bold text-white mb-6 flex items-center gap-3">
                    <i data-lucide="copyright" class="w-6 h-6 text-pink-400"></i>
