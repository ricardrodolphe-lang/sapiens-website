...
<section class="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-12 text-slate-300 leading-relaxed">
            ...
            <div>
                <h3 class="text-xl font-bold text-white mb-4">1. Responsable du traitement</h3>
                <p>
            ...
            <div>
                <h3 class="text-xl font-bold text-white mb-4">3. Utilisation des données</h3>
                <p>Vos données sont traitées pour les finalités suivantes :</p>
                <ul class="list-disc pl-5 mt-2 space-y-1">
                    <li>Répondre à vos demandes de contact et d'audit.</li>
                    <li>Établir des devis commerciaux.</li>
                    <li>Gérer la relation client (facturation, suivi de projet).</li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p class="mt-2">Nous ne vendons ni ne louons jamais vos données à des tiers.</p>
            </div>
